...
class Login extends Component{
    ...
    changeEmail = (e) => {
        this.props.loginStore.changeEmail(e.target.value);
    }
        ...
        return (
            ...
            <main className={this.props.classes.main}>
                ...
                <form className={this.props.classes.form}>
                    ...
                    <Input onChange={this.changePassword} id="password" name="password" type="password" autoComplete="current-password" />
                    </FormControl>
                    <FormControlLabel
...
export default withStyles(styles)(inject('loginStore')(observer(Login)));